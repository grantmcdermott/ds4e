...
```{r rstudio_server_login_pic, echo=FALSE, out.width = "100%"}
knitr::include_graphics("pics/gce-i/rstudio-server-login.png")
```

And we're all set. Here is RStudio Server running on my laptop via Google Chrome.

```{r rstudio_server_open_pic, echo=FALSE, out.width = "100%"}
knitr::include_graphics("pics/gce-i/rstudio-server-open.png")
```
...
```{r rstudio_export_pic, echo=FALSE, out.width = "100%"}
knitr::include_graphics("pics/gce-i/rstudio-export.png")
```
