...
```{r rstudio_debug_pic, echo=FALSE, out.width = "100%"}
knitr::include_graphics("pics/funcs-adv/rstudio-debug.png")
```
...
```{r debug_ex1_pic, echo=FALSE, out.width = "100%"}
knitr::include_graphics("pics/funcs-adv/debug_ex1.png")
```
...
```{r debug_prompt_pic, echo=FALSE, out.width = "100%"}
knitr::include_graphics("pics/funcs-adv/debug_prompt.png")
```
